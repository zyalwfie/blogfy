          ...
          <main class="mt-6">
            <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
              <a class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10"
                href="https://laravel.com/docs" id="docs-card">
                <div class="relative flex w-full flex-1 items-stretch" id="screenshot-container">
                  <img alt="Laravel documentation screenshot"
                ...
                <div class="relative flex items-center gap-6 lg:items-end">
                  ...
                  <svg class="size-6 shrink-0 stroke-[#FF2D20]" fill="none" stroke-width="1.5" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
              ...
              <a class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20] lg:pb-10"
                ...
                <div class="size-12 sm:size-16 flex shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10">
                  <svg class="size-5 sm:size-6" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <g fill="#FF2D20">
                      <path
                ...
                <svg class="size-6 shrink-0 self-center stroke-[#FF2D20]" fill="none" stroke-width="1.5"
